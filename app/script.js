...
const recommendedSpots = [
  {
    ...
    routeMode: "transit",
    busLink: "https://www.jorudan.co.jp/bus/rosen/stoplist/?Ddd=3&Dhh=17&Dmn=5&Dym=202606&jyosya=%E8%A5%BF%E4%B9%9D%E6%9D%A1&lid=1532197#jump",
    isMeetingPlace: true,
  ...
  },
  {
    ...
    description: "大阪城天守閣を中心に、石垣や堀、季節の花を楽しめる大阪定番の観光スポット。",
  },
  {
    name: "中之島公園",
    area: "北区",
    center: [34.6922, 135.5048],
    description: "川と歴史的建築に囲まれた落ち着いた公園。散歩やカフェ巡りにも向いています。",
  },
  {
    name: "道頓堀",
    area: "中央区",
    center: [34.6687, 135.5013],
    description: "グリコ看板や派手な立体看板が並ぶ大阪らしいエリア。食べ歩きにもおすすめです。",
  },
  {
    name: "新世界・通天閣",
    area: "浪速区",
    center: [34.6525, 135.5063],
    description: "通天閣を眺めながら串カツ店やレトロな街並みを楽しめる、にぎやかな観光地です。",
  },
  {
    name: "天王寺公園",
    area: "天王寺区",
    center: [34.6491, 135.5112],
    description: "駅近で芝生広場や動物園、美術館も楽しめる、ゆっくり過ごしやすい公園です。",
  },
  {
    name: "長居公園",
    area: "東住吉区",
    center: [34.6127, 135.5172],
    description: "植物園やスタジアムがある広い公園。散歩、ランニング、自然観察にぴったりです。",
  },
  {
    name: "天保山・大阪港",
    area: "港区",
    center: [34.6546, 135.4295],
    description: "海遊館や大観覧車が近く、港の景色も楽しめるベイエリアの人気スポットです。",
  },
  {
    name: "咲洲コスモスクエア",
    area: "住之江区",
    center: [34.6382, 135.4146],
    description: "海沿いの開放感があるエリア。展望台や夕景、イベント帰りの散策にもおすすめです。",
  },
  {
    name: "住吉大社",
    area: "住吉区",
    center: [34.6129, 135.4936],
    description: "反橋で知られる歴史ある神社。大阪らしい下町散歩と合わせて訪れたい場所です。",
  },
  {
    name: "靱公園",
    area: "西区",
    center: [34.6843, 135.4932],
    description: "都会の中で緑を感じられる公園。周辺にはカフェやベーカリーも多く休憩に便利です。",
  },
  {
    name: "花博記念公園 鶴見緑地",
    area: "鶴見区",
    center: [34.7127, 135.5741],
    description: "広い園内で花や緑を楽しめる公園。風車の丘や季節の景色が見どころです。",
  },
  {
    name: "毛馬桜之宮公園",
    area: "都島区",
    center: [34.7057, 135.5201],
    description: "大川沿いに続く散歩道が魅力。春の桜や川辺の景色を楽しみながら歩けます。",
  },
];
